 ...
 *
 * The argument should be in the form: Innovate_Client\Namespace. The
...
spl_autoload_register( function( $class_name ) {
	...
	if ( false === strpos( $class_name, 'PH_Slack' ) ) {
		return;
	}
	...
	$filepath  = trailingslashit( untrailingslashit( dirname( __DIR__ ) . '/includes' ) . $namespace );
	$filepath .= $file_name;
